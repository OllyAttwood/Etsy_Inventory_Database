...
def prepare_dropdown_options_lists(list_of_options_lists):
    """
    Inserts an empty string at the beginning of each of the lists, to use as the default
    (unfiltered) value for a dropdown menu. Also orders the list alphabetically. Does
    these actions in-place (i.e. modifies existing lists)
    """
